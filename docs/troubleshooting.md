...
Потеря связи с брокером записывается в журнал одним предупреждением, а возврат — одним информационным сообщением «restored». Неудачные попытки между ними видны только в отладочных логях.
