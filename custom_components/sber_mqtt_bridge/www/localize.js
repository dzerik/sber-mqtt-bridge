...
export const EN_FALLBACK = {
  ...
  // --- diff ---
  "confirm.title": "Command Confirmation",
  "confirm.hint": "For every Sber command: did the state the bridge reported back to Sber reach the commanded values? A trace only shows that a service call was made; a command that stays unconfirmed means the device, or its integration, did not follow it.",
  "confirm.clear": "Clear",
  "confirm.filter_status": "Filter by status",
  "confirm.search": "Filter by entity",
  "confirm.empty": "No commands from Sber yet.",
  "confirm.nothing_matches": "No commands match the filters.",
  "confirm.status_pending": "Waiting",
  "confirm.status_confirmed": "Confirmed",
  "confirm.status_partial": "Partial",
  "confirm.status_not_confirmed": "Not confirmed",
  "confirm.status_superseded": "Superseded",
  "confirm.col_key": "Feature",
  "confirm.col_sent": "Sent by Sber",
  "confirm.col_reported": "Reported back",
  "confirm.col_match": "Match",
  "confirm.key_matched": "The reported value matches the command",
  "confirm.key_differs": "The reported value differs from the command",
  "confirm.key_not_reported": "No state reported for this feature yet",
  "confirm.copy": "Copy JSON",
  "diff.title": "State Diffs",
  "diff.clear": "Clear",
  "diff.hint": "Each row is the difference between two consecutive state publishes of one device; identical publishes produce no row. Rows are grouped by device, the most recently changed first.",
  "diff.search": "Filter by entity",
  "diff.empty": "No changes yet. The first real state change will appear here.",
  "diff.nothing_matches": "No devices match the filter.",
  "diff.initial": "initial",
  "diff.show_earlier": "Show {count} earlier",
  "diff.hide_earlier": "Hide {count} earlier",
  "diff.count_title": "{count} changes in the buffer",
  // --- table ---
  ...
  "devtools.log_pause": "Pause",
  "devtools.log_resume": "Resume",
  "devtools.log_copy_shown": "Copy shown",
  "devtools.log_all_directions": "All directions",
  "devtools.log_dir_in": "Incoming",
  "devtools.log_dir_out": "Outgoing",
  "devtools.log_dir_replay": "Replay / inject",
  "devtools.log_all_topics": "All topics",
  "devtools.log_search": "Search topic or payload",
  "devtools.log_shown": "{shown} of {total}",
  "devtools.log_new_while_paused": "{count} new while paused",
  "devtools.log_empty": "No MQTT messages yet. They appear here as they are sent and received.",
  "devtools.log_nothing_matches": "No messages match the filters.",
  ...
  "replay.hint": "Feed a Sber-shaped MQTT message into the bridge without touching the broker. Works offline; the same dispatcher, trace, command confirmation and state diff see it.",
  "replay.subscribe_failed": "Subscribe failed: {reason}",
  "replay.injected": "Injected → {suffix}",
  "replay.unknown_topic": "Unknown topic suffix: {suffix}",
  "replay.inject_failed": "Inject failed: {reason}",
  "replay.replayed": "Replayed → {suffix}",
  "replay.replay_failed": "Replay failed: {reason}",
  "replay.reset_template": "Reset template",
  "replay.empty": "No incoming messages yet. Real Sber traffic will appear here.",
  "replay.replay": "Replay",
  "replay.builder": "Command builder",
  "replay.builder_hint": "Pick an exposed entity, a feature it accepts and a value — the builder composes the down/commands payload Sber would send, with the right value type and bounds. Several features make one multi-key command.",
  "replay.builder_entity": "Entity",
  "replay.builder_feature": "Feature",
  "replay.builder_value": "Value",
  "replay.builder_add": "Add",
  "replay.builder_remove": "Remove {key}",
  "replay.builder_compose": "Put into the editor",
  "replay.builder_composed": "Command placed into the editor — check it and press Inject.",
  "replay.builder_nothing": "This entity accepts no commands (its features are read-only).",
  "replay.schema_failed": "Could not load the entity's features: {reason}",
